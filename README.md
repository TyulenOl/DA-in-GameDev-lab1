...
Параметр Lr отвечает за величину шага, от которого зависит насколько быстро или медлено будет происходить приближение к оптимальным коэффициентам a и b.
